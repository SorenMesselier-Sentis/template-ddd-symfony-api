...
final class AttachmentIdType extends Type
{
    use DoctrineStringValueTypeTrait;

    public const NAME = 'project_attachment_id';
    ...
    public function convertToPHPValue(mixed $value, AbstractPlatform $platform): ?AttachmentId
    {
        if (null === $value) {
            return null;
        }

        return AttachmentId::fromString(self::assertString($value, self::NAME));
    }
    ...
    public function convertToDatabaseValue(mixed $value, AbstractPlatform $platform): ?string
    {
        ...
        if ($value instanceof AttachmentId) {
            return $value->value();
        }
