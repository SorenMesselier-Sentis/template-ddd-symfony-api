...
final class UpdateMeCommandHandler
{
    ...
    public function __invoke(UpdateMeCommand $command): void
    {
        $userId = $this->userContext->userId();
        $this->logger->info('Updating own profile', ['id' => $userId->value()]);
        ...
        $this->logger->info('Own profile updated', ['id' => $userId->value()]);
    }
}
