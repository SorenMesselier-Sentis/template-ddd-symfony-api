...
use App\ApiClient\Application\Command\DeleteApiClient\DeleteApiClientCommandHandler;
...
final class DeleteApiClientCommandHandlerTest extends UnitTestCase
{
    ...
    private DeleteApiClientCommandHandler $handler;
    ...
    protected function setUp(): void
    {
        ...
        $this->handler = new DeleteApiClientCommandHandler(
            $this->repository,
    ...
    public function testItSoftDeletesTheClientAndRevokesItsTokens(): void
    {
        $entity = ApiClientMother::create();
        $command = new DeleteApiClientCommand(id: $entity->id()->value());
    ...
    public function testItThrowsWhenTheClientIsNotFound(): void
    {
        ...
        ($this->handler)(new DeleteApiClientCommand(id: ApiClientId::random()->value()));
    }
}
